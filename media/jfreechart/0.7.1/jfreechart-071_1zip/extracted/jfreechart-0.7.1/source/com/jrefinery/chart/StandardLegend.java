 ...
 *
 * $Id: StandardLegend.java,v 1.10 2001/12/03 09:53:13 mungady Exp $
 *
...
//            String [] legendItemLabels = data.getLegendItemLabels();
            ...
            LegendItem[] rectangles = new LegendItem[legendItemLabels.length];
            ...
            if (horizontal) {
                ...
                for (int i=0; i<legendItemLabels.length; i++) {
                    rectangles[i] = createLegendItem(graphics, legendItemLabels[i], xoffset,
                                                     totalHeight);
...
/**
 * Utility class representing one item in a legend.
 */
