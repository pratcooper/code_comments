 ...
 *                   Hans-Jurgen Greiner;
 *
 * $Id: JFreeChartPanel.java,v 1.11 2001/12/13 09:29:41 mungady Exp $
 *
 ...
 */
public class JFreeChartPanel extends JComponent implements ActionListener, MouseListener,
                                                           Printable,
                                                           ChartChangeListener {
...
//    protected static final double ZOOM_PERCENT = 0.25;
	...
	setPreferredSize(new Dimension(width, height));
        ...
        if (tooltips) {
            this.info = new DrawInfo(new StandardToolTipsCollection());
    ...
    /**
     * Handle a mouse click.  The chart may be buffered, and it may be scaled.
     */
    public void mouseClicked(MouseEvent e) {
        ...
        chart.handleClick((int)((e.getX()-insets.left)/scaleX), (int)((e.getY()-insets.top)/scaleY), info);
    ...
    private void attemptSaveAs() {
        ...
        if (option==JFileChooser.APPROVE_OPTION) {
            try {
                ...
                System.out.println("Problem saving chart: "+e.getMessage());
            }
        }
    ...
    public void zoomIn() {
        ...
        if ((zoomStatus >= MAX_ZOOM_LEVEL) && zoomInMenuItem.isEnabled()) {
    ...
    public void zoomOut() {
        ...
        if ((zoomStatus <= -MAX_ZOOM_LEVEL) && zoomOutMenuItem.isEnabled()) {
